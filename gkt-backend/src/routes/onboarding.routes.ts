...
router.get('/configuration-status', onboardingController.getConfigurationStatus);
...
router.patch('/agents/:id/password', onboardingController.setAgentPassword);
router.get('/ticket-settings', onboardingController.getTicketSettings);
