...
export default function SetupChannelsPage() {
  ...
  return (
    <div>
      <div style={{ marginBottom: 8, fontSize: 13, color: accentBrand, fontWeight: 600 }}>Step 8</div>
      <h1 style={{ fontSize: 24, fontWeight: 800, marginBottom: 8 }}>Support Channels</h1>
      <p style={{ fontSize: 15, color: textSecondary, marginBottom: 28 }}>
        Chat widget, web form, and email-to-ticket. Configure in Admin after setup.
      </p>
